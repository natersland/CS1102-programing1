...
public abstract class StringValue {
    ...
    public static final String COURSE_IS_FULL = "Course is full!";
    ...
    public static final String NO_GRADES_RECORDED = "No grade recorded!";

    public static final String GRADE = "Grade: ";

    public static final String OVERALL_GRADE = "Overall grade: ";
